...
class DataFeedModel {
  ...
  factory DataFeedModel.fromRawJson(String str) => DataFeedModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DataFeedModel.fromJson(Map<String, dynamic> json) => DataFeedModel(
